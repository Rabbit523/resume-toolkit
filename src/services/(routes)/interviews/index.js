...
const API_URL = config.baseApiUrl + `interviews/`;

class InterviewService extends BaseApiProvider {
  ...
  // ✅ Update interview (PUT /interview/:id)
  ...
  // ✅ Delete interview (DELETE /interview/:id)
